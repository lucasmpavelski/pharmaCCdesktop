...
#
# Created: Thu Nov 17 20:52:40 2011
...
class Ui_Form(object):
    def setupUi(self, Form):
        ...
        QtCore.QObject.connect(self.pid, QtCore.SIGNAL("textEdited(QString)"), Form.save)
        QtCore.QObject.connect(self.name, QtCore.SIGNAL("textEdited(QString)"), Form.save)
        QtCore.QObject.connect(self.phone, QtCore.SIGNAL("textEdited(QString)"), Form.save)
